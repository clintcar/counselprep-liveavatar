...
export declare const getAgentEventEmitArgs: (
  event: AgentEvent,
...
export type CommandEvent =
  ...
  | CommandEventData<
      CommandEventsEnum.AVATAR_SPEAK_TEXT,
      {
        text: string;
      }
    >
  | CommandEventData<
      CommandEventsEnum.AVATAR_SPEAK_RESPONSE,
      {
        text: string;
      }
    >
  | CommandEventData<
      CommandEventsEnum.AVATAR_SPEAK_AUDIO,
      {
        audio: string;
      }
    >
